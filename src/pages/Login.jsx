...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-cyber-bg px-4 py-8 font-mono">
      <div className="max-w-md w-full cyber-panel p-8 shadow-2xl">
        <div className="flex justify-center mb-6">
          <div className="p-3 border border-cyber-primary bg-cyber-primary/10">
        ...
        <form onSubmit={handleSubmit} className="space-y-5 mb-8">
          <div>
            ...
            <input 
              type="email" 
              required
              className="w-full bg-[#0a0f0d] border border-cyber-border px-4 py-3 text-cyber-text focus:outline-none focus:border-cyber-primary transition-colors focus:shadow-[0_0_15px_rgba(0,255,102,0.1)]"
              value={email}
        ...
        <div className="flex gap-4">
          <button
            ...
            disabled={loading}
            className="flex-1 flex items-center justify-center gap-2 bg-[#141b18] border border-cyber-border hover:border-cyber-primary hover:text-cyber-primary text-cyber-text font-bold py-3 transition-colors disabled:opacity-50 uppercase tracking-widest text-sm"
          >
