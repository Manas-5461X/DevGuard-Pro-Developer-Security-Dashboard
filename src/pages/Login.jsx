    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0A0A0A] px-4 py-10 font-sans">
      ...
      <div className="relative max-w-sm w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[#737373] text-sm">Sign in to DevGuard Pro</p>
        </div>
        ...
        <div className="flex items-center my-6">
          ...
          <span className="px-3 text-[#525252] text-xs">or continue with</span>
          <div className="flex-1 h-px bg-[#1A1A1A]" />
        </div>
        ...
        <p className="text-center text-[#525252] mt-8 text-sm">
          ...
          <Link to="/signup" className="text-cyber-primary hover:text-white font-semibold transition-colors">
            Sign up free
          </Link>
        </p>
      </div>
